...
## Project Structure
    ...
    ├── mcfarland_and_sons_29127  # Django project configurations
...
1. Clone this repo and `cd mcfarland_and_sons_29127`
...
2. Clone this repo and `cd mcfarland_and_sons_29127`
